        ...
        <div class="mb-2">
          <div class="row">
            <div class="col-sm-3">
              ...
              <input type="text" name="available-amount" id="available-amount" class=" form-control text-success" value="" disabled>
            </div>
            <div class="col-sm-3">
            ...
            <div class="col-sm-3">
              ...
              <input type="date" name="available-amount" id="" class=" form-control text-success" value="" disabled>
            </div>
          </div>
          <div class="mb-2">
            <div class="row">
              <div class="col-sm-3">
                ...
                <input type="text" name="available-amount" id="" class=" form-control text-success" value="" disabled >
              </div>
              <div class="col-sm-3">
